...
public class LoginActivity extends AppCompatActivity implements LoginView {
    ...
    public void initLogin() {
        ...
        if (TextUtils.isEmpty(phone)) {
            ...
            phoneTextView.setError(getString(R.string.error_invalid_phone));
            focusView = phoneTextView;
            cancelLogin = true;
        }
    ...
    public void loginFail(String module, int errCode, String errMsg) {
        ...
        Toast.makeText(LoginActivity.this, "登录失败" + MySelfInfo.getInstance().getId() + " : "+errMsg, Toast.LENGTH_SHORT).show();
        showProgress(false);
        initView(true);
    }
}
